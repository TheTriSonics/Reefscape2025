...
class ManipLocations:
    ...
    # __init__ method
    HOME = ManipLocation(0.5, -80, 37) 
    DRIVE_UP = ManipLocation(0.5, 90, 90)
    INTAKE_CORAL = ManipLocation(0.5, -90, 37) 
    CORAL_REEF_1 = ManipLocation(0.5, -71, 171)
    CORAL_REEF_2 = ManipLocation(17, -63.1, 40)
    CORAL_REEF_3 = ManipLocation(42.5, -63.1, 40)
    CORAL_REEF_3_UP = ManipLocation(25, 63.1, 166)
    ...
    BARGE_6 = ManipLocation(40, 90, -20)
